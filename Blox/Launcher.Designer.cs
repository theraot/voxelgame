namespace Hexpoint.Blox
{
	partial class Launcher
	{
		...
		private void InitializeComponent()
		{
			...
			this.cbCreativeMode = new System.Windows.Forms.CheckBox();
			this.rbSinglePlayer = new System.Windows.Forms.RadioButton();
			this.rbJoinServer = new System.Windows.Forms.RadioButton();
			this.lblWorld = new System.Windows.Forms.Label();
			this.ddlWorld = new System.Windows.Forms.ComboBox();
			this.btnStart = new System.Windows.Forms.Button();
			this.txtNewWorldName = new System.Windows.Forms.TextBox();
			this.ddlNewWorldType = new System.Windows.Forms.ComboBox();
			this.gbNewWorld = new System.Windows.Forms.GroupBox();
			this.cbTrees = new System.Windows.Forms.CheckBox();
			this.label7 = new System.Windows.Forms.Label();
			this.txtSeed = new System.Windows.Forms.TextBox();
			this.label5 = new System.Windows.Forms.Label();
			this.label3 = new System.Windows.Forms.Label();
			this.ddlNewWorldSize = new System.Windows.Forms.ComboBox();
			...
			this.mnuLaunchServer = new System.Windows.Forms.ToolStripMenuItem();
			...
			// cbCreativeMode
			// 
			this.cbCreativeMode.AutoSize = true;
			this.cbCreativeMode.BackColor = System.Drawing.Color.Transparent;
			this.cbCreativeMode.Checked = true;
			this.cbCreativeMode.CheckState = System.Windows.Forms.CheckState.Checked;
			this.cbCreativeMode.Location = new System.Drawing.Point(438, 69);
			this.cbCreativeMode.Name = "cbCreativeMode";
			this.cbCreativeMode.Size = new System.Drawing.Size(95, 17);
			this.cbCreativeMode.TabIndex = 5;
			this.cbCreativeMode.Text = "Creative Mode";
			this.cbCreativeMode.UseVisualStyleBackColor = false;
			// 
			// rbSinglePlayer
			// 
			this.rbSinglePlayer.AutoSize = true;
			this.rbSinglePlayer.BackColor = System.Drawing.Color.Transparent;
			this.rbSinglePlayer.Checked = true;
			this.rbSinglePlayer.Font = new System.Drawing.Font("Microsoft Sans Serif", 11.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.rbSinglePlayer.Location = new System.Drawing.Point(135, 10);
			this.rbSinglePlayer.Name = "rbSinglePlayer";
			this.rbSinglePlayer.Size = new System.Drawing.Size(124, 22);
			this.rbSinglePlayer.TabIndex = 0;
			this.rbSinglePlayer.TabStop = true;
			this.rbSinglePlayer.Text = "Single Player";
			this.rbSinglePlayer.UseVisualStyleBackColor = false;
			this.rbSinglePlayer.CheckedChanged += new System.EventHandler(this.GameMode_Changed);
			// 
			// rbJoinServer
			// 
			this.rbJoinServer.AutoSize = true;
			this.rbJoinServer.BackColor = System.Drawing.Color.Transparent;
			this.rbJoinServer.Font = new System.Drawing.Font("Microsoft Sans Serif", 11.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.rbJoinServer.Location = new System.Drawing.Point(273, 10);
			this.rbJoinServer.Name = "rbJoinServer";
			this.rbJoinServer.Size = new System.Drawing.Size(112, 22);
			this.rbJoinServer.TabIndex = 2;
			this.rbJoinServer.Text = "Join Server";
			this.rbJoinServer.UseVisualStyleBackColor = false;
			this.rbJoinServer.CheckedChanged += new System.EventHandler(this.GameMode_Changed);
			// 
			// lblWorld
			// 
			...
			// ddlWorld
			// 
			this.ddlWorld.BackColor = System.Drawing.SystemColors.Control;
			this.ddlWorld.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.ddlWorld.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
			this.ddlWorld.FormattingEnabled = true;
			this.ddlWorld.Location = new System.Drawing.Point(82, 67);
			this.ddlWorld.MaxLength = 24;
			this.ddlWorld.Name = "ddlWorld";
			this.ddlWorld.Size = new System.Drawing.Size(177, 21);
			this.ddlWorld.TabIndex = 4;
			this.ddlWorld.SelectedIndexChanged += new System.EventHandler(this.ddlWorld_SelectedIndexChanged);
			// 
			// btnStart
			// 
			...
			// ddlNewWorldType
			// 
			this.ddlNewWorldType.BackColor = System.Drawing.SystemColors.Control;
			...
			// gbNewWorld
			// 
			this.gbNewWorld.BackColor = System.Drawing.Color.Transparent;
			this.gbNewWorld.Controls.Add(this.cbTrees);
			this.gbNewWorld.Controls.Add(this.label7);
			this.gbNewWorld.Controls.Add(this.txtSeed);
			this.gbNewWorld.Controls.Add(this.label5);
			this.gbNewWorld.Controls.Add(this.label3);
			this.gbNewWorld.Controls.Add(this.ddlNewWorldSize);
			this.gbNewWorld.Controls.Add(this.label6);
			this.gbNewWorld.Controls.Add(this.label1);
			this.gbNewWorld.Controls.Add(this.ddlNewWorldType);
			this.gbNewWorld.Controls.Add(this.txtNewWorldName);
			this.gbNewWorld.Enabled = false;
			this.gbNewWorld.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
			this.gbNewWorld.Location = new System.Drawing.Point(10, 92);
			this.gbNewWorld.Name = "gbNewWorld";
			this.gbNewWorld.Size = new System.Drawing.Size(249, 121);
			this.gbNewWorld.TabIndex = 20;
			this.gbNewWorld.TabStop = false;
			this.gbNewWorld.Text = "New World Settings";
			// 
			// cbTrees
			// 
			this.cbTrees.AutoSize = true;
			this.cbTrees.Checked = true;
			this.cbTrees.CheckState = System.Windows.Forms.CheckState.Checked;
			this.cbTrees.Location = new System.Drawing.Point(50, 99);
			this.cbTrees.Name = "cbTrees";
			this.cbTrees.Size = new System.Drawing.Size(91, 17);
			this.cbTrees.TabIndex = 56;
			this.cbTrees.Text = "Include Trees";
			this.cbTrees.UseVisualStyleBackColor = true;
			// 
			// label7
			// 
			...
			// ddlNewWorldSize
			// 
			this.ddlNewWorldSize.BackColor = System.Drawing.SystemColors.Control;
			this.ddlNewWorldSize.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.ddlNewWorldSize.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
			this.ddlNewWorldSize.FormattingEnabled = true;
			this.ddlNewWorldSize.Location = new System.Drawing.Point(174, 46);
			this.ddlNewWorldSize.MaxLength = 24;
			this.ddlNewWorldSize.Name = "ddlNewWorldSize";
			this.ddlNewWorldSize.Size = new System.Drawing.Size(66, 21);
			this.ddlNewWorldSize.TabIndex = 23;
			// 
			// label6
			// 
			...
			// mnuLaunchServer
			// 
			this.mnuLaunchServer.Name = "mnuLaunchServer";
			this.mnuLaunchServer.Size = new System.Drawing.Size(148, 22);
			this.mnuLaunchServer.Text = "Launch Server";
			this.mnuLaunchServer.Click += new System.EventHandler(this.mnuLaunchServer_Click);
			// 
			// toolStripMenuItem2
			// 
			...
			this.Controls.Add(this.gbNewWorld);
			this.Controls.Add(this.btnStart);
			this.Controls.Add(this.ddlWorld);
			this.Controls.Add(this.lblWorld);
			this.Controls.Add(this.rbJoinServer);
			this.Controls.Add(this.rbSinglePlayer);
			this.Controls.Add(this.cbCreativeMode);
			...
			this.gbNewWorld.ResumeLayout(false);
			this.gbNewWorld.PerformLayout();
		...
		private System.Windows.Forms.CheckBox cbCreativeMode;
		private System.Windows.Forms.RadioButton rbSinglePlayer;
		private System.Windows.Forms.RadioButton rbJoinServer;
		private System.Windows.Forms.Label lblWorld;
		private System.Windows.Forms.ComboBox ddlWorld;
		private System.Windows.Forms.Button btnStart;
		private System.Windows.Forms.TextBox txtNewWorldName;
		private System.Windows.Forms.ComboBox ddlNewWorldType;
		private System.Windows.Forms.GroupBox gbNewWorld;
		private System.Windows.Forms.Label label6;
		private System.Windows.Forms.Label label1;
		private System.Windows.Forms.Label label3;
		private System.Windows.Forms.ComboBox ddlNewWorldSize;
		...
		private System.Windows.Forms.CheckBox cbTrees;
